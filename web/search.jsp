    ...
    <body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= dto.getStatus()%></td>
                <td>
                    <a href="MainController?action=Edit&txtFoodID=<%= dto.getFoodID()%>&txtMinimum=<%= request.getParameter("txtMinimum")%>&txtMaximum=<%= request.getParameter("txtMaximum")%>">Edit</a>
                </td>
                <td>
                    <a href="MainController?action=Delete&txtFoodID=<%= dto.getFoodID()%>&txtMinimum=<%= request.getParameter("txtMinimum")%>&txtMaximum=<%= request.getParameter("txtMaximum")%>">Delete</a>
                </td>
            </tr>            
            <%
                }
